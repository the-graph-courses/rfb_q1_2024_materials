...
# Accidents de Moto depuis le dossier "data". 
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# INSTRUCTION : Utilisez {esquisse} pour générer deux figures {ggplot2} qui démontrent chacun des POINTS énumérés ci-dessous 
# (Si vous savez comment travailler directement avec ggplot, vous pouvez ignorer esquisse)

# POINT A : La catégorie d'âge la plus fréquente était "20-24".
# Conseil : Le type de graphique recommandé est un DIAGRAMME À BARRES d'une variable.


# POINT B : La majorité des victimes féminines étaient passagères, et non conductrices.
...
# -- Le nombre d'accidents à Medellin était-il en augmentation ou en diminution entre 2012 et 2015
